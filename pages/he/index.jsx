...
const competitionSteps = [
  ...
  {
    text: "הקבוצות שיכינו את הסרטונים שעונים בצורה הכי טובה על הדרישות יעלו לגמר שיתקיים ב- 23.04 באוניברסיטת תל אביב, בו יועצים מכל התחומים (תעשייה, אקדמיה ומשרד החינוך) יעזרו לכם לפתח את הרעיון ולהציג אותו מול פאנל השופטים שלנו.",
...
const formSrc =
  "https://docs.google.com/forms/d/1y35NnIsmjgR_0ROrB5glcK9fhsRZxiC_QZ8a3q4A76I/viewform?edit_requested=true";

const overviewInfo = [
  {
    text: "פרויקט ה- iGEM הינו פרויקט ייחודי, בו סטודנטים מאוניברסיטאות מכל העולם מתבקשים ליזום פרויקט מחקר בתחום הביולוגיה הסינתטית, ולבסוף להציג את תוצאותיהם בתחרות בינלאומית המתקיימת מדי שנה בפריז. תחרות הISRAGEM היא תחרות המאורגנת על ידי קבוצת iGEM 2026 מאוניברסיטת תל אביב, ומיועדת לתלמידי תיכון מכל מגמות הלימוד. התחרות מאפשרת לתלמידים בישראל להתנסות בחוויה דומה כבר בתיכון.",
